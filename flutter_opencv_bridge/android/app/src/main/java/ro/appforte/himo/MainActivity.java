...
//        StandaloneHelper.onRequestPermissionsResult(requestCode, permissions, grantResults);
    ...
    public void configureFlutterEngine(io.flutter.embedding.engine.FlutterEngine flutterEngine) {
        Log.d(TAG, "rrrrrrrrrrrconfigureFlutterEngine() start");
        ...
        new EventChannel(flutterEngine.getDartExecutor().getBinaryMessenger(), EVENT_CHANNEL)
                .setStreamHandler(new EventChannel.StreamHandler() {
                    ...
                    public void onListen(Object args, EventChannel.EventSink events) {
                        ...
                        StandaloneHelper.setEventSink(events);
                    }

                    @Override
                    public void onCancel(Object args) {
                        Log.d(TAG, "EventChannel onCancel()");
                        StandaloneHelper.setEventSink(null);
                    }
                });
//        new EventChannel(flutterEngine.getDartExecutor().getBinaryMessenger(), EVENT_CHANNEL)
//                .setStreamHandler(new EventChannel.StreamHandler() {
//                    @Override
//                    public void onListen(Object args, EventChannel.EventSink events) {
//                        Log.d(TAG, "rrrrrrrrrEventChannel onListen() called with args=" + args);
//                        StandaloneHelper.setEventSink(events);
//
//                        CameraPreview preview = CameraPreviewFactory.getLastCreatedView();
//                        if (preview != null) {
//                            StandaloneHelper.startCamera(preview.getCameraView(), events);
//                            Log.d(TAG, "rrrrrrrrrrrCamera started via StandaloneHelper");
//                        } else {
//                            Log.w(TAG, "rrrrrrrrrrrNo CameraPreview available yet");
//                        }
//                    }
//
//                    @Override
...
//                            result.success("setCameraSize " + width + "x" + height);
        ...
        flutterEngine.getPlatformViewsController()
                .getRegistry()
                .registerViewFactory("camera_preview", new CameraPreviewFactory(this));
